...
from particles.gravity import UNIVERSAL_CONSTANT_OF_MAKE_GRAVITY_LESS_STUPIDLY_SMALL
from particles import keyframes, interpolate
from particles.constants import *
